...
const updateOrganization = () => {
    form.transform((data) => ({
        ...data,
        _method: 'put',
    })).post(route('organization.update', props.organization.id), {
    ...
    <AppLayout>
        <div class="px-4 py-8 max-w-6xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <Link href="#" class="flex items-center gap-1 hover:text-black text-gray-600">
                ...
                <div>
                    ...
                    <div class="mb-4">
                        <div
                            ...
                            <img :src="logoUrl || '/images/organization.png'" alt="Logo" class="object-contain h-full" />
                        </div>
                    </div>
                    <input
                        type="file"
