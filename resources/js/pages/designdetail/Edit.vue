  ...
  <AppLayout>
    <div class="px-6 py-10 max-w-5xl mx-auto">
      ...
      <div class="bg-white p-8 rounded-xl shadow space-y-8">
        ...
        <Input
          type="textarea"
          label="SVG Path or Markup"
          v-model="form.image"
          :error="props.errors.image"
          placeholder="Paste SVG path or full markup"
          rows="5"
          required="true"
        >
          <template #icon>
        ...
        <!-- SVG Preview -->
        <div class="border p-6 rounded-lg bg-gray-50 flex justify-center items-center min-h-[120px]">
          <div v-if="imagePreview" v-html="imagePreview" class="max-w-[120px] max-h-[120px]"></div>
