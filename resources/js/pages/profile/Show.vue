...
const customer = reactive({
  name: 'Jermaine Reeves',
  email: 'vanobedoku@mailinator.com'
});
</script>
<template>
  <AppLayout>
    ...
    <div class="px-4 py-8 max-w-6xl mx-auto">
      ...
      <div class="flex flex-col lg:mt-5 gap-3 rounded-lg lg:border lg:border-primary p-0 lg:p-4">
        ...
        <div>
          <Input type="email" label="Email" color="grayBorder" :required="true" v-model="customer.email" />
        </div>
        <div>
        ...
        <div>
          <Input type="url" label="Organization Logo" color="grayBorder" :required="true" />
        </div>
        <div>
