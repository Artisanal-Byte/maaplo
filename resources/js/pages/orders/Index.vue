                        ...
                        <div
                            ...
                            <div @click="toggleDropdown()">
                                <div class="flex gap-2">
                                    <h1
                                        class="font-[Lato] font-medium text-[18px] leading-[16px] tracking-[0] text-black">
                                        Order
                                        Status
                                    </h1>
                                    <Icon v-if="showDropdown == false" icon="icon-park-outline:down" width="20"
                                ...
                                <ul class="text-md text-black dark:text-black" aria-labelledby="dropdownTrigger">
                                    <li>
                                        <div class="flex flex-col ml-2 gap-1 text-black ml-2">
                                            ...
                                            <div>
                                                <Input type="radio" id="in-alteration" label="In Alteration"
                                                    name="status" radioValue="in_alteration" v-model="selectedStatus" />
