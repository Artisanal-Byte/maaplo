                        ...
                        <form @submit.prevent="submit" class="flex flex-col gap-6 w-full max-w-sm">
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input id="name" type="text" required autofocus :tabindex="1" autocomplete="name"
                                    v-model="form.name" placeholder="Name" class="border border-black h-12 bg-white text-black" />
                            ...
                            <div class="grid gap-2">
                                ...
                                <Input id="email" type="email" required :tabindex="2" autocomplete="email"
                                    v-model="form.email" placeholder="Email" class="border border-black h-12 bg-white text-black" />
