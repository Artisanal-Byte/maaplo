                ...
                <li>
                    <div class="grid grid-col-1 lg:grid-cols-2 gap-x-4 gap-y-4 ml-2 mt-4 text-black font-lato text-sm">
                        ...
                        <div class="flex items-center gap-4 col-span-2 sm:col-span-1">
                            ...
                            <Input v-model="measurements.length" type="number" width="md" color="grayBorder" padding="sm"
                                rounded="sm" />
                        ...
                        <div class="flex items-center gap-4 col-span-2 sm:col-span-1">
                            ...
                            <Input v-model="measurements.chest" type="number" width="md" color="grayBorder" padding="sm"
                                rounded="sm" />
                            <span class="text-sm text-gray-500">{{ unit }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-4 col-span-2 sm:col-span-1">
                            ...
                            <Input v-model="measurements.arms" type="number" width="md" color="grayBorder" padding="sm"
                                rounded="sm" />
                            <span class="text-sm text-gray-500">{{ unit }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-4 col-span-2 sm:col-span-1">
                            ...
                            <Input v-model="measurements.shoulder" type="number" width="md" color="grayBorder"
                                padding="sm" rounded="sm" />
                            <span class="text-sm text-gray-500">{{ unit }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-4 col-span-2 sm:col-span-1">
                            ...
                            <Input v-model="measurements.waist" type="number" width="md" color="grayBorder" padding="sm"
                                rounded="sm" />
                            <span class="text-sm text-gray-500">{{ unit }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-4 col-span-2 sm:col-span-1">
                            ...
                            <Input v-model="measurements.seat" type="number" width="md" color="grayBorder" padding="sm"
                                rounded="sm" />
                            <span class="text-sm text-gray-500">{{ unit }}</span>
                        </div>
